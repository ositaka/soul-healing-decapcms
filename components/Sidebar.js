      ...
      <div className="card mb-4">
        ...
        <div className="card-body">
          <div className="input-group">
            ...
            <Link href={{ pathname: '/Search', query: { q: search?.toLowerCase() } }} className="btn btn-primary" id="button-search">Go!</Link>
          </div>
        </div>
      </div>
                    ...
                    post => {
                      return post.categories.map(
                        item => {
                          ...
                          return <Link key={item} href={`/category/${slug}`}><li> {item} </li></Link>
                        }
                      )
