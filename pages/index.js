                ...
                <div className='section__content'>
                  ...
                  <div style={{ display: 'flex', height: '200px' }}>
                    ...
                    <svg id="sw-js-blob-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path fill="url(#sw-gradient)"
                        d="M32.2,-11C36.3,2.2,30.5,18.2,19.9,25.4C9.3,32.7,-6.2,31.3,-18.1,23.1C-30,14.9,-38.4,-0.1,-34.7,-12.7C-31.1,-25.3,-15.6,-35.5,-0.8,-35.2C14,-35,28,-24.3,32.2,-11Z" width="100%" height="100%" transform="translate(50 50)" stroke-width="0"
                        style={{ transition: "all 0.3s ease 0s;" }}></path>
                    </svg>
                    ...
                    <svg id="sw-js-blob-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <path fill="url(#sw-gradient)"
                        d="M28.2,-18.1C33.1,-7.8,31.3,4.6,25.5,13.5C19.7,22.3,9.8,27.7,-1.1,28.3C-12,28.9,-24,24.8,-29.1,16.3C-34.3,7.9,-32.7,-5,-26.7,-15.9C-20.7,-26.9,-10.3,-35.8,0.7,-36.2C11.7,-36.6,23.3,-28.4,28.2,-18.1Z" width="100%" height="100%" transform="translate(50 50)" stroke-width="0"
                        style={{ transition: "all 0.3s ease 0s;" }}></path>
                    </svg>
