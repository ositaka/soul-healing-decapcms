...
import Post from '../../components/Work'
...
export async function getStaticPaths() {
  ...
  // const posts = allWorks.map((post) => pick(post, ["title", "date", "slug", "description", "draft", "image", "tags", "categories"]));
...
export async function getStaticProps({ params }) {
  ...
  //   help of pick get require filter value
  const posts = allWorks.map((post) => pick(post, ["title", "date", "slug", "description", "image", "tags", "categories", "id"]));
